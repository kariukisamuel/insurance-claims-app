        ...
        <v-row class="my-2 pa-5">
            <v-col class="pa-5">
                <v-tabs fixed-tabs background-color="#3750EB" show-arrows center-active dark v-model="tabs">
                    ...
                    <v-tab href="#tab-5">Disapproved By CFA</v-tab>
                    <v-tab href="#tab-4">Approved By CFA</v-tab>
                </v-tabs>
                                        ...
                                        <v-col cols="12" sm="6" md="4">
                                            <v-menu ref="menu1" v-model="menu1" :close-on-content-click="false"
                                                ...
                                                <template v-slot:activator="{ on, attrs }">
                                                    <v-text-field v-model="date" label="Filter By Date Range"
